            ...
            <ScrollReveal stagger={0.12} className='grid grid-cols-1 md:grid-cols-2 items-center'>
                <div className='relative -pl-50 z-10'>
                    ...
                    <div className='relative md:-mr-24 md:-mt-6 z-20 max-w-5xl rounded-2xl p-5 bg-white/6 backdrop-blur-sm border border-white/10 shadow-[0_6px_50px_rgba(126,34,206,0.25)]'>
                        <p className='text-sm p-4 text-white/75'>A sleek, modern e-commerce and Business platform built with Next.js, React, TypeScript, Tailwind CSS, and MongoDB. It delivers a fast, responsive, and seamless shopping experience with dynamic products, smart filtering, secure authentication, cart management, and smooth checkout. Built with clean architecture, reusable components, and scalable backend functionality, this project combines modern design, powerful performance, and real-world functionality to create a professional, production-ready web experience.</p>
